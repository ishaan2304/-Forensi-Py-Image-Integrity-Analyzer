...
**Forensi-Py: Image Integrity Analyzer**  is a mii-project developed for a Computer Science and Digital Forensics (CSDF) course, focusing on the critical task of verifying the authenticity and detecting lmanipulation in digital imag
